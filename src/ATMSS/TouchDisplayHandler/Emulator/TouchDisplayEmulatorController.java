...
public class TouchDisplayEmulatorController {
	...
	public void initialize(String id, AppKickstarter appKickstarter, Logger log,
			TouchDisplayEmulator touchDisplayEmulator) {
		this.id = id;
	...
	// buttonPressed
	public void buttonPressedWelcome(ActionEvent actionEvent) {
		String btnTxt = "Login";
		touchDisplayMBox.send(new Msg(id, touchDisplayMBox, Msg.Type.TD_UpdateDisplay, btnTxt));
	} // buttonPressed
} // TouchDisplayEmulatorController
